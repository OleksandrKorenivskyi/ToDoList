...
const createTask = (id: string, categoryName: string, description: string, dueDate: string, completed: boolean) => {
  return { id, categoryName, description, dueDate, completed };
};
